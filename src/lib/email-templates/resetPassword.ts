function resetPasswordTemplate(userId: string, resetLink: string) {
    return `
                    ...
                    <tr>
                        <td style="padding: 40px 40px 20px 40px;">
                                ...
                                <div style="display: flex; align-items: flex-start; gap: 12px;">
                                    ...
                                    <div>
                                        ...
                                        <p style="margin: 0; color: #7f1d1d; font-size: 14px; line-height: 1.5;">
                                            A password reset request has been made for your government services account.
                            ...
                            <div
                                ...
                                <div
                                    style="display: flex; justify-content: space-around; align-items: center; font-size: 14px;">
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <p style="margin: 0 0 20px 0; color: #374151; font-size: 16px; line-height: 1.7;">
                                    Click the button below to securely reset your password. This link will redirect you
                                    to a secure government portal where you can create a new password.
                                </p>
